...
ZIP=/tmp/pango-1.24.2.zip
DEVZIP=/tmp/pango-dev-1.24.2.zip
cd /usr/local

mkdir -p share/doc/pango-1.24.2
cp -p /home/qwazix/cordia/pango-1.24.2/COPYING share/doc/pango-1.24.2

mkdir -p share/doc/pango-dev-1.24.2
cp -p /home/qwazix/cordia/pango-1.24.2/COPYING share/doc/pango-dev-1.24.2
...
zip -r $ZIP share/doc/pango-1.24.2
...
zip -r $DEVZIP share/doc/pango-dev-1.24.2
